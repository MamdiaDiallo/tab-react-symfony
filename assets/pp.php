...
import React, { Fragment, useState, UseEffect, useEffect } from "react";
///requete http
import axios from "axios";
import Aclient from './components/Clients';
...
useEffect(() => {
axios.get("https://localhost:8001/api/utilisateurs").then(
...
<div>
    ...
    <form onSubmit={this.handleSubmit}>
        <input ref={this.clientInput} type="text" placeholder="Ajourter un client" />
